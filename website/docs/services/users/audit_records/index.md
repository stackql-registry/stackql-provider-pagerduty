...
<tr><td><b>Id</b></td><td><CopyableCode code="pagerduty.users.audit_records" /></td></tr>
</tbody></table>
...
<Tabs
    defaultValue="list_users_audit_records"
    values={[
        { label: 'list_users_audit_records', value: 'list_users_audit_records' }
    ]}
>
<TabItem value="list_users_audit_records">
...
<tbody>
<tr>
    <td><a href="#list_users_audit_records"><CopyableCode code="list_users_audit_records" /></a></td>
    ...
    <td>The response will include audit records with changes that are made to the identified user not changes made by the identified user.<br /><br /><br />The returned records are sorted by the `execution_time` from newest to oldest.<br /><br />See [`Cursor-based pagination`](https://developer.pagerduty.com/docs/rest-api-v2/pagination/) for instructions on how to paginate through the result set.<br /><br />For more information see the [Audit API Document](https://developer.pagerduty.com/docs/rest-api-v2/audit-records-api/).<br /><br />Scoped OAuth requires: `audit_records.read`<br /></td>
</tr>
<tr>
    <td><a href="#_list_users_audit_records"><CopyableCode code="_list_users_audit_records" /></a></td>
...
<Tabs
    defaultValue="_list_users_audit_records"
    values={[
        { label: '_list_users_audit_records', value: '_list_users_audit_records' }
    ]}
>
<TabItem value="_list_users_audit_records">
