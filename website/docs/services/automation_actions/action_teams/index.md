...
Creates, updates, deletes, gets or lists an <code>action_teams</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="action_teams" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="pagerduty.automation_actions.action_teams" /></td></tr>
</tbody></table>
...
- name: action_teams
  props:
    - name: id
      value: "{{ id }}"
      description: Required parameter for the action_teams resource.
    - name: team
      description: |
        (opaque JSON object)
      value:
