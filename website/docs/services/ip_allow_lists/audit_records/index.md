...
<tr><td><b>Id</b></td><td><CopyableCode code="pagerduty.ip_allow_lists.audit_records" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-X-EARLY-ACCESS"><code>X-EARLY-ACCESS</code></a>, <a href="#parameter-limit"><code>limit</code></a>, <a href="#parameter-cursor"><code>cursor</code></a>, <a href="#parameter-since"><code>since</code></a>, <a href="#parameter-until"><code>until</code></a></td>
    <td>&lt;!-- theme: warning --&gt;&lt;br /&gt;&lt;br /&gt;&gt; ### Early Access&lt;br /&gt;&gt; This API is in Early Access and may change at any time. You must pass the `X-EARLY-ACCESS: ip-allow-lists` header on every request, and your account must be enrolled in the IP Allow Lists Early Access program. Contact your PagerDuty account team to request access.&lt;br /&gt;&lt;br /&gt;The response will include audit records with changes that are made to the given IP allow list.&lt;br /&gt;&lt;br /&gt;The returned records are sorted by the `execution_time` from newest to oldest.&lt;br /&gt;&lt;br /&gt;See &#91;`Cursor-based pagination`&#93;(https:​//developer.pagerduty.com/docs/rest-api-v2/pagination/) for instructions on how to paginate through the result set.&lt;br /&gt;&lt;br /&gt;For more information see the &#91;Audit API Document&#93;(https:​//developer.pagerduty.com/docs/rest-api-v2/audit-records-api/).&lt;br /&gt;&lt;br /&gt;Scoped OAuth requires: `audit_records.read`&lt;br /&gt;</td>
</tr>
</tbody>
</table>
