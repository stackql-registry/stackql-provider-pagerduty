--- 
title: incident_metrics_by_escalation_policy
hide_title: false
hide_table_of_contents: false
keywords:
  - incident_metrics_by_escalation_policy
  - analytics
  - pagerduty
...
Creates, updates, deletes, gets or lists an <code>incident_metrics_by_escalation_policy</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="incident_metrics_by_escalation_policy" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="pagerduty.analytics.incident_metrics_by_escalation_policy" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>ID of the escalation policy the incident was last assigned to. Not included when aggregating by all.</td>
</tr>
<tr>
    <td><CopyableCode code="team_id" /></td>
    <td><code>string</code></td>
    <td>ID of the team the incident was assigned to. Not included when aggregating by all.</td>
</tr>
<tr>
    <td><CopyableCode code="escalation_policy_name" /></td>
    <td><code>string</code></td>
    <td>Name of the escalation policy the incident was last assigned to. Not included when aggregating by all.</td>
</tr>
<tr>
    <td><CopyableCode code="team_name" /></td>
    <td><code>string</code></td>
    <td>Name of the team the incident was assigned to. Not included when aggregating by all.</td>
</tr>
<tr>
    <td><CopyableCode code="distinct_responder_count" /></td>
    <td><code>integer</code></td>
    <td>Distinct count of responders who engaged in incidents on the escalation policy</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>Start of the date range that the metrics were calculated for. Only included when an aggregate unit is specified in the request.</td>
</tr>
<tr>
...
<tr>
    ...
    <td>The percentage of time in the defined date range that the service was not interrupted by a &#91;major incident&#93;(https:​//support.pagerduty.com/docs/operational-reviews#major-incidents). Not included when aggregating by all.</td>
</tr>
</tbody>
</table>
</TabItem>
...
up_time_pct
FROM pagerduty.analytics.incident_metrics_by_escalation_policy
;
```
</TabItem>
</Tabs>
