...
Creates, updates, deletes, gets or lists a <code>metrics_incidents_teams</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><code>metrics_incidents_teams</code></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="pagerduty.analytics.metrics_incidents_teams" /></td></tr>
</tbody></table>
...
<Tabs
    defaultValue="get_analytics_metrics_incidents_team"
    values={[
        { label: 'get_analytics_metrics_incidents_team', value: 'get_analytics_metrics_incidents_team' }
    ]}
>
<TabItem value="get_analytics_metrics_incidents_team">
...
filters,
time_zone
FROM pagerduty.analytics.metrics_incidents_teams
;
```
</TabItem>
</Tabs>
